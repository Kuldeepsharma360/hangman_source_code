def image():
    image_paths = [r'D:\hang.png', r'D:\img5.jpg', r'D:\img4.jpg', r'D:\img3.png', r'D:\img2.png', r'D:\img1.png']
    img = Image.open(image_paths[n])
    img = img.resize((200, 200), Image.ANTIALIAS)
    img = ImageTk.PhotoImage(img)
    panel = Label(root, image=img)
    panel.grid(row=2, pady=100)
    image = Image.open(image_paths[n])
...
worldlist = ['water', 'pizza', 'green', 'tool', 'men', 'womem']
